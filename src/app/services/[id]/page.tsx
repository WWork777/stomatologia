...
import SpecialistsService from "@/components/services/specialists/specialists-slider";
...
export default async function ServicePage({
  ...
  return (
    <div className="container">
      ...
      {hasFeatures && <PricingAccordion service={service} />}
...
export async function generateMetadata({
  ...
  return {
    ...
    alternates: {
      canonical: `https://stomatologiya42.ru/services/${service.id}`,
    },
    openGraph: {
      title: `${service.title} в Кемерово`,
      description: service.description,
      url: `https://stomatologiya42.ru/services/${service.id}`,
